...
namespace JoltPhysics
{
    void EditorProxyPhysicsAsset::Reflect(AZ::ReflectContext* context)
    {
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            {
                editContext->Class<EditorProxyPhysicsAsset>(QT_TRANSLATE_NOOP("JoltPhysics", "EditorProxyPhysicsAsset"), QT_TRANSLATE_NOOP("JoltPhysics", "Jolt Asset."))
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default,
                        &EditorProxyPhysicsAsset::m_pxAsset,
                        QT_TRANSLATE_NOOP("JoltPhysics", "Jolt Mesh"),
                        QT_TRANSLATE_NOOP("JoltPhysics", "Specifies the Jolt mesh collider asset for this Jolt collider component."))
                        ->Attribute(AZ_CRC_CE("EditButton"), "")
                        ->Attribute(AZ_CRC_CE("EditDescription"), QT_TRANSLATE_NOOP("JoltPhysics", "Open in Scene Settings"))
                        ->Attribute(AZ_CRC_CE("DisableEditButtonWhenNoAssetSelected"), true)
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default,
                        &EditorProxyPhysicsAsset::m_configuration,
                        QT_TRANSLATE_NOOP("JoltPhysics", "Configuration"),
                        QT_TRANSLATE_NOOP("JoltPhysics", "Jolt mesh asset collider configuration."))
    ...
    void EditorProxyAssetShapeConfig::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto* editContext = serializeContext->GetEditContext())
            {
                editContext->Class<EditorProxyAssetShapeConfig>(QT_TRANSLATE_NOOP("JoltPhysics", "EditorProxyAssetShapeConfig"), QT_TRANSLATE_NOOP("JoltPhysics", "Jolt asset collider."))
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default,
                        &EditorProxyAssetShapeConfig::m_physicsAsset,
                        QT_TRANSLATE_NOOP("JoltPhysics", "Asset"),
                        QT_TRANSLATE_NOOP("JoltPhysics", "Configuration of asset shape."))
                        ->Attribute(AZ::Edit::Attributes::ChangeNotify, &EditorProxyAssetShapeConfig::OnConfigurationChanged)
                        ->Attribute(AZ::Edit::Attributes::NameLabelOverride, &EditorProxyAssetShapeConfig::JoltMeshAssetShapeTypeName)
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default,
                        &EditorProxyAssetShapeConfig::m_subdivisionLevel,
                        QT_TRANSLATE_NOOP("JoltPhysics", "Subdivision level"),
                        QT_TRANSLATE_NOOP("JoltPhysics", "The level of subdivision if a primitive shape is replaced with a convex mesh due to scaling."))
    ...
    AZStd::string EditorProxyAssetShapeConfig::JoltMeshAssetShapeTypeName() const
    {
        ...
        if (auto serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            if (auto editContext = serializeContext->GetEditContext())
            {
                editContext
                    ...
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &EditorMeshColliderComponent::m_configuration, QT_TRANSLATE_NOOP("JoltPhysics", "Collider Configuration"), QT_TRANSLATE_NOOP("JoltPhysics", "Configuration of the collider."))
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ...
                    ->DataElement(
                        ...
                        QT_TRANSLATE_NOOP("JoltPhysics", "Shape Configuration"),
                        QT_TRANSLATE_NOOP("JoltPhysics", "Configuration of physics asset shape."))
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &EditorMeshColliderComponent::OnConfigurationChanged)
                    ...
                    ->DataElement(
                        ...
                        QT_TRANSLATE_NOOP("JoltPhysics", "Component Mode"),
                        QT_TRANSLATE_NOOP("JoltPhysics", "Collider Component Mode."))
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default,
                        &EditorMeshColliderComponent::m_colliderDebugDraw,
                        QT_TRANSLATE_NOOP("JoltPhysics", "Debug draw settings"), QT_TRANSLATE_NOOP("JoltPhysics", "Debug draw settings."))
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ;
            }
        }
    ...
    void EditorMeshColliderComponent::Activate()
    {
        ...
        JoltPhysics::MeshColliderComponentRequestsBus::Handler::BusConnect(entityId);
    ...
    void EditorMeshColliderComponent::Deactivate()
    {
        ...
        JoltPhysics::MeshColliderComponentRequestsBus::Handler::BusDisconnect();
    ...
    void EditorMeshColliderComponent::UpdateMaterialSlotsFromMeshAsset()
    {
        ...
        AzToolsFramework::ScopedUndoBatch undoBatch("Jolt editor mesh collider component material slots updated");
    ...
    void EditorMeshColliderComponent::ValidateAssetMaterials()
    {
        ...
        AZ_Warning("Jolt", usedIndices.size() == materialsNum,
    ...
    {
        const JoltPhysics::EditorRigidBodyComponent* entityRigidbody = m_entity->FindComponent<JoltPhysics::EditorRigidBodyComponent>();
        ...
        if (entityRigidbody && m_proxyShapeConfiguration.m_physicsAsset.m_pxAsset.IsReady())
        {
            ...
            {
                auto current_shape = AZStd::rtti_pointer_cast<JoltPhysics::Shape>(shape);
                if (current_shape &&
                    static_cast<JPH::Shape*>(current_shape->GetNativePointer())->GetSubType() == JPH::EShapeSubType::Mesh &&
    ...
    {
        const JoltPhysics::EditorMeshColliderComponent* editorMeshColliderComponent =
            azrtti_cast<const JoltPhysics::EditorMeshColliderComponent*>(instance);
