...
namespace JoltPhysics
{
    struct EditorProxyPhysicsAsset
    {
        ...
        AZ_TYPE_INFO(EditorProxyPhysicsAsset, "{6E1FA706-998E-43AA-A768-5C9389D7E0F6}");
    ...
    struct EditorProxyAssetShapeConfig
    {
        ...
        AZ_TYPE_INFO(EditorProxyAssetShapeConfig, "{C7B970D3-5DF2-4AA0-B532-0A3D6B0C3303}");
        static void Reflect(AZ::ReflectContext* context);
    ...
    private:
        ...
        AZStd::string JoltMeshAssetShapeTypeName() const;
    ...
    //! Editor Jolt Mesh Collider Component.
    class EditorMeshColliderComponent
        ...
        , private JoltPhysics::MeshColliderComponentRequestsBus::Handler
        ...
        , private JoltPhysics::EditorMeshColliderComponentRequestBus::Handler
        , private JoltPhysics::EditorMeshColliderValidationRequestBus::Handler
        , private AzPhysics::SimulatedBodyComponentRequestsBus::Handler
        , public AzFramework::BoundsRequestBus::Handler
    {
    public:
        AZ_RTTI(EditorMeshColliderComponent, "{9752D9BB-AA3C-4C93-A93A-E21B0D876679}", AzToolsFramework::Components::EditorComponentBase);
    ...
    private:
        ...
        // JoltMeshColliderComponentRequestBus overrides ...
        ...
        // JoltPhysics::EditorMeshColliderComponentRequestBus overrides ...
        void SetAssetScale(const AZ::Vector3& scale) override;
        AZ::Vector3 GetAssetScale() const override;

        // JoltPhysics::EditorMeshColliderValidationRequestBus overrides ...
