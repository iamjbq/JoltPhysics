...
namespace JoltPhysics
{
    ...
    {
    public:
        AZ_EBUS_BEHAVIOR_BINDER(BehaviorRigidBodyNotificationBusHandler, "{D2276816-9B61-41C5-94FB-3C8DDBEED104}", AZ::SystemAllocator,
            OnPhysicsEnabled,
            OnPhysicsDisabled
        );
    ...
    void RigidBodyComponent::Activate()
    {
        ...
        {
            AZ_Warning("RigidBodyComponent", false, "It is not valid to have a Jolt Dynamic Rigid Body Component "
