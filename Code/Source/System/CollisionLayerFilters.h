...
namespace JoltPhysics
{
    ...
    public:
        ...
        {
			AZ::u8 collisionLayer1 = inObject1;
        	AZ::u8 collisionLayer2 = inObject2;

			if (JoltPhysics::JoltSystem* system = GetJoltSystem())
			{
				AzPhysics::CollisionConfiguration collisionConfig = system->GetConfiguration()->m_collisionConfig;
