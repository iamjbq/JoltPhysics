...
namespace JoltPhysics
{
    namespace Pipeline
    {
        ...
        public:
            AZ_TYPE_INFO(TriangleMeshAssetParams, "{27CD27DF-F146-43CC-9E1B-41EE253DE9D4}");
        ...
        public:
            AZ_TYPE_INFO(ConvexAssetParams, "{BACE4BDC-5B50-42FB-9FCE-C31CD19AA1A0}");
        ...
        public:
            AZ_TYPE_INFO(PrimitiveAssetParams, "{F76A33B9-92A2-4DB7-958F-04D74560B211}");
        ...
        public:
            ...
            AZ_TYPE_INFO(ConvexDecompositionParams, "{9A07728B-558E-40CC-8DD8-496E9A837D00}");
        ...
        {
        public:
            AZ_RTTI(MeshGroup, "{2CCAA504-25C1-43F3-9375-E36E989DAC7F}", AZ::SceneAPI::DataTypes::ISceneNodeGroup);
