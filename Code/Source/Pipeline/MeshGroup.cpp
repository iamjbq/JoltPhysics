    ...
    namespace Pipeline
    {
        ...
        void TriangleMeshAssetParams::Reflect(AZ::ReflectContext* context)
        {
            ...
            )
            {
                ...
                {
                    editContext->Class<TriangleMeshAssetParams>(QT_TRANSLATE_NOOP("JoltPhysics", "Triangle Mesh Asset Parameters"),
                        QT_TRANSLATE_NOOP("JoltPhysics", "Configure the parameters controlling the exported triangle mesh asset."))

                        ->DataElement(AZ_CRC_CE("MergeMeshes"), &TriangleMeshAssetParams::m_mergeMeshes, QT_TRANSLATE_NOOP("JoltPhysics", "Merge Meshes"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>When set, all selected nodes will be merged into a single collision mesh. Otherwise "
                        ...
                        ->DataElement(AZ_CRC_CE("WeldVertices"), &TriangleMeshAssetParams::m_weldVertices, QT_TRANSLATE_NOOP("JoltPhysics", "Weld Vertices"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>When set, mesh welding is performed. Clean mesh must be enabled.</span>"))

                        ->DataElement(AZ_CRC_CE("DisableCleanMesh"), &TriangleMeshAssetParams::m_disableCleanMesh, QT_TRANSLATE_NOOP("JoltPhysics", "Disable Clean Mesh"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>When set, mesh cleaning is disabled. This makes cooking faster. When clean mesh is "
                            "not performed, mesh welding is also not performed.</span>"))

                        ->DataElement(AZ_CRC_CE("Force32BitIndices"), &TriangleMeshAssetParams::m_force32BitIndices, QT_TRANSLATE_NOOP("JoltPhysics", "Force 32-Bit Indices"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>When set, 32-bit indices will always be created regardless of triangle count."
                            "</span>"))

                        ->DataElement(AZ_CRC_CE("SuppressTriangleMeshRemapTable"), &TriangleMeshAssetParams::m_suppressTriangleMeshRemapTable, QT_TRANSLATE_NOOP("JoltPhysics", "Suppress Triangle Mesh Remap Table"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>When true, the face remap table is not created. This saves a significant amount of "
                        ...
                        ->DataElement(AZ_CRC_CE("BuildTriangleAdjacencies"), &TriangleMeshAssetParams::m_buildTriangleAdjacencies, QT_TRANSLATE_NOOP("JoltPhysics", "Build Triangle Adjacencies"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>When true, the triangle adjacency information is created. You can get the adjacency "
                            "triangles for a given triangle from getTriangle.</span>"))

                        ->DataElement(AZ_CRC_CE("MeshWeldTolerance"), &TriangleMeshAssetParams::m_meshWeldTolerance, QT_TRANSLATE_NOOP("JoltPhysics", "Mesh Weld Tolerance"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Mesh weld tolerance. If mesh welding is enabled, this controls the distance at "
                        ...
                        ->DataElement(AZ_CRC_CE("NumTrisPerLeaf"), &TriangleMeshAssetParams::m_numTrisPerLeaf, QT_TRANSLATE_NOOP("JoltPhysics", "Number of Triangles Per Leaf"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Mesh cooking hint for max triangles per leaf limit. Fewer triangles per leaf "
        ...
        void ConvexAssetParams::Reflect(AZ::ReflectContext* context)
        {
            ...
            )
            {
                ...
                {
                    editContext->Class<ConvexAssetParams>(QT_TRANSLATE_NOOP("JoltPhysics", "Convex Asset Parameters"),
                        QT_TRANSLATE_NOOP("JoltPhysics", "Configure the parameters controlling the exported convex asset."))
                        ->DataElement(AZ_CRC_CE("AreaTestEpsilon"), &ConvexAssetParams::m_areaTestEpsilon, QT_TRANSLATE_NOOP("JoltPhysics", "Area Test Epsilon"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>If the area of a triangle of the hull is below this value, the triangle will be "
                        ...
                        ->DataElement(AZ_CRC_CE("PlaneTolerance"), &ConvexAssetParams::m_planeTolerance, QT_TRANSLATE_NOOP("JoltPhysics", "Plane Tolerance"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>The value is used during hull construction. When a new point is about to be added "
                        ...
                        ->DataElement(AZ_CRC_CE("Use16bitIndices"), &ConvexAssetParams::m_use16bitIndices, QT_TRANSLATE_NOOP("JoltPhysics", "Use 16-bit Indices"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Denotes the use of 16-bit vertex indices in Convex triangles or polygons. "
                            "Otherwise, 32-bit indices are assumed.</span>"))

                        ->DataElement(AZ_CRC_CE("CheckZeroAreaTriangles"), &ConvexAssetParams::m_checkZeroAreaTriangles, QT_TRANSLATE_NOOP("JoltPhysics", "Check Zero Area Triangles"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Checks and removes almost zero-area triangles during convex hull computation. The "
                            "rejected area size is specified in Area Test Epsilon.</span>"))

                        ->DataElement(AZ_CRC_CE("QuantizeInput"), &ConvexAssetParams::m_quantizeInput, QT_TRANSLATE_NOOP("JoltPhysics", "Quantize Input"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Quantizes the input vertices using the k-means clustering.</span>"))

                        ->DataElement(AZ_CRC_CE("UsePlaneShifting"), &ConvexAssetParams::m_usePlaneShifting, QT_TRANSLATE_NOOP("JoltPhysics", "Use Plane Shifting"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Enables plane shifting vertex limit algorithm. Plane shifting is an alternative "
                        ...
                        ->DataElement(AZ_CRC_CE("ShiftVertices"), &ConvexAssetParams::m_shiftVertices, QT_TRANSLATE_NOOP("JoltPhysics", "Shift Vertices"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Convex hull input vertices are shifted to be around origin to provide better "
                        ...
                        ->DataElement(AZ_CRC_CE("GaussMapLimit"), &ConvexAssetParams::m_gaussMapLimit, QT_TRANSLATE_NOOP("JoltPhysics", "Gauss Map Limit"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Vertex limit beyond which additional acceleration structures are computed for each "
                        ...
                        ->DataElement(AZ_CRC_CE("BuildGpuData"), &ConvexAssetParams::m_buildGpuData, QT_TRANSLATE_NOOP("JoltPhysics", "Build GPU Data"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>When true, additional information required for GPU-accelerated rigid body "
        ...
        void ConvexDecompositionParams::Reflect(AZ::ReflectContext* context)
        {
            ...
            )
            {
                ...
                {
                    editContext->Class<ConvexDecompositionParams>(QT_TRANSLATE_NOOP("JoltPhysics", "Decomposition Parameters"),
                        QT_TRANSLATE_NOOP("JoltPhysics", "Configure the parameters controlling the approximate convex decomposition algorithm."))

                        ->DataElement(AZ_CRC_CE("MaxConvexHulls"), &ConvexDecompositionParams::m_maxConvexHulls, QT_TRANSLATE_NOOP("JoltPhysics", "Maximum Hulls"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Controls the maximum number of hulls to generate.</span>"))
                            ->Attribute(AZ::Edit::Attributes::Min, 1)
                            ->Attribute(AZ::Edit::Attributes::Max, 100000)

                        ->DataElement(AZ_CRC_CE("MaxNumVerticesPerConvexHull"), &ConvexDecompositionParams::m_maxNumVerticesPerConvexHull, QT_TRANSLATE_NOOP("JoltPhysics", "Maximum Vertices Per Hull"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Controls the maximum number of triangles per convex hull.</span>"))
                            ->Attribute(AZ::Edit::Attributes::Min, 8)
                            ->Attribute(AZ::Edit::Attributes::Max, 2048)

                        ->DataElement(AZ_CRC_CE("Resolution"), &ConvexDecompositionParams::m_resolution, QT_TRANSLATE_NOOP("JoltPhysics", "Resolution"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Maximum number of voxels generated during the voxelization stage.</span>"))
                            ->Attribute(AZ::Edit::Attributes::Min, 10000)
                            ->Attribute(AZ::Edit::Attributes::Max, 10000000)
                            ->Attribute(AZ::Edit::Attributes::Step, 10000)

                        ->ClassElement(AZ::Edit::ClassElements::Group, QT_TRANSLATE_NOOP("JoltPhysics", "Advanced"))
                            ->Attribute(AZ::Edit::Attributes::AutoExpand, false)

                        ->DataElement(AZ_CRC_CE("MinVolumePercentError"), &ConvexDecompositionParams::m_minVolumePercentError, QT_TRANSLATE_NOOP("JoltPhysics", "Minimum Volume % Per Hull"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Controls the voxels within % of the volume of the hull is allowed.</span>"))
                        ...
                        ->DataElement(AZ_CRC_CE("MaxRecursionDepth"), &ConvexDecompositionParams::m_maxRecursionDepth, QT_TRANSLATE_NOOP("JoltPhysics", "Max Recursion Depth"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Controls the maximum recursion depth.</span>"))
                            ->Attribute(AZ::Edit::Attributes::Min, 2)
                            ->Attribute(AZ::Edit::Attributes::Max, 64)

                        ->DataElement(AZ::Edit::UIHandlers::CheckBox, &ConvexDecompositionParams::m_shrinkWrap, QT_TRANSLATE_NOOP("JoltPhysics", "Shrink Wrap"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Control whether to shrinkwrap the voxel positions to the source mesh on output</span>"))

                        ->DataElement(AZ::Edit::UIHandlers::ComboBox, &ConvexDecompositionParams::m_fillMode, QT_TRANSLATE_NOOP("JoltPhysics", "Fill Mode"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Select how the voxels as filled to create a solid object.</span>"))
                            ->Attribute(
                                AZ::Edit::Attributes::EnumValues,
                                AZStd::vector<AZ::Edit::EnumConstant<FillMode>>{
                                    AZ::Edit::EnumConstant<FillMode>(FillMode::FloodFill, QT_TRANSLATE_NOOP("JoltPhysics", "Flood fill")),
                                    AZ::Edit::EnumConstant<FillMode>(FillMode::SurfaceOnly, QT_TRANSLATE_NOOP("JoltPhysics", "Surface only")),
                                    AZ::Edit::EnumConstant<FillMode>(FillMode::RaycastFill, QT_TRANSLATE_NOOP("JoltPhysics", "Raycast fill")),
                                })

                        ->DataElement(AZ_CRC_CE("MinEdgeLength"), &ConvexDecompositionParams::m_minEdgeLength, QT_TRANSLATE_NOOP("JoltPhysics", "Max Edge Length"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Once a voxel patch has an edge length of less than 4 on all 3 sides, we don't keep recursing.</span>"))
                            ->Attribute(AZ::Edit::Attributes::Min, 1)
            ...
            )
            {
                ...
                )
                {
                    editContext->Class<MeshGroup>(QT_TRANSLATE_NOOP("JoltPhysics", "PhysX Mesh group"), QT_TRANSLATE_NOOP("JoltPhysics", "Configure PhysX mesh data exporting."))
                        ...
                        ->DataElement(AZ::Edit::UIHandlers::Default, &MeshGroup::m_nodeSelectionList, QT_TRANSLATE_NOOP("JoltPhysics", "Select meshes"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Select the meshes to be included in the mesh group.</span>"))
                        ...
                        ->DataElement(AZ::Edit::UIHandlers::ComboBox, &MeshGroup::m_exportMethod, QT_TRANSLATE_NOOP("JoltPhysics", "Export As"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>The cooking method to be applied to this mesh group. For the asset to be usable as "
                            "a rigid body, select \"Convex\" or \"Primitive\".</span>"))
                            ->EnumAttribute(MeshExportMethod::TriMesh, QT_TRANSLATE_NOOP("JoltPhysics", "Triangle Mesh"))
                            ->EnumAttribute(MeshExportMethod::Convex, QT_TRANSLATE_NOOP("JoltPhysics", "Convex"))
                            ->EnumAttribute(MeshExportMethod::Primitive, QT_TRANSLATE_NOOP("JoltPhysics", "Primitive"))
                            ->Attribute(AZ::Edit::Attributes::ChangeNotify, &MeshGroup::OnExportMethodChanged)

                        ->DataElement(AZ_CRC_CE("DecomposeMeshes"), &MeshGroup::m_decomposeMeshes, QT_TRANSLATE_NOOP("JoltPhysics", "Decompose Meshes"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>If enables, this option will apply the V-HACD algorithm to split each node "
                        ...
                        ->DataElement(AZ_CRC_CE("TriangleMeshAssetParams"), &MeshGroup::m_triangleMeshAssetParams, QT_TRANSLATE_NOOP("JoltPhysics", "Triangle Mesh Asset Parameters"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Configure the parameters controlling the exported triangle mesh asset.</span>"))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &MeshGroup::GetExportAsTriMesh)
                            ->Attribute(AZ::Edit::Attributes::AutoExpand, true)

                        ->DataElement(AZ_CRC_CE("ConvexAssetParams"), &MeshGroup::m_convexAssetParams, QT_TRANSLATE_NOOP("JoltPhysics", "Convex Asset Parameters"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Configure the parameters controlling the exported convex asset.</span>"))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &MeshGroup::GetExportAsConvex)
                            ->Attribute(AZ::Edit::Attributes::AutoExpand, true)

                        ->DataElement(AZ_CRC_CE("PrimitiveAssetParams"), &MeshGroup::m_primitiveAssetParams, QT_TRANSLATE_NOOP("JoltPhysics", "Primitive Asset Parameters"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Configure the parameters controlling the exported primitive asset.</span>"))
                            ->Attribute(AZ::Edit::Attributes::Visibility, &MeshGroup::GetExportAsPrimitive)
                            ->Attribute(AZ::Edit::Attributes::AutoExpand, true)

                        ->DataElement(AZ_CRC_CE("ConvexDecompositionParams"), &MeshGroup::m_convexDecompositionParams, QT_TRANSLATE_NOOP("JoltPhysics", "Decomposition Parameters"),
                            QT_TRANSLATE_NOOP("JoltPhysics", "<span>Configure the parameters controlling the approximate convex decomposition algorithm.</span>"))
                        ...
                        ->DataElement(AZ::Edit::UIHandlers::Default, &MeshGroup::m_rules, "",
                            QT_TRANSLATE_NOOP("JoltPhysics", "Add or remove rules to fine-tune the export process."))
