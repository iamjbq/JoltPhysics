    ...
    namespace Debug
    {
        ...
        /*static*/ void DebugDisplayData::Reflect(AZ::ReflectContext* context)
        {
            ...
            if (auto* serialize = azrtti_cast<AZ::SerializeContext*>(context))
            {
                ...
                {
                    editContext->Class<DebugDisplayData>("Editor Configuration", "Editor settings for Jolt.")
                        ...
                        ->DataElement(AZ::Edit::UIHandlers::ComboBox, &DebugDisplayData::m_globalCollisionDebugDraw, "Global Collision Debug",
                            ...
                            "<li><b>Enable all colliders</b><br>Displays all Jolt collider shapes, including colliders previously set as hidden.\n</li>"
                            "<li><b>Disable all colliders</b><br>Hides all Jolt collider shapes, including colliders previously set as visible.\n</li>"
                            "<li><b>Set manually</b><br>You can update Jolt colliders on each entity. The default state is on.</li>"
                            "</ul>")
