...
namespace JoltPhysics
{
    ...
    namespace Utils
    {
        ...
        //! Creates a convex hull configuration from a primitive shape by extracting the triangles and storing points
        //! A convex hull cannot have more than 256 unique points but shared points should be accounted for.
        AZStd::optional<Physics::ConvexHullShapeConfiguration> CreateConvexFromPrimitive(
            const Physics::ColliderConfiguration& colliderConfig,
            const Physics::ShapeConfiguration& primitiveShapeConfig, const AZ::Vector3& scale, AZ::u8 subdivisionLevel);
        ...
        // TODO: These are no longer relevant I believe
