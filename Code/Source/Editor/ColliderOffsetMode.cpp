...
namespace JoltPhysics
{
    ...
    void ColliderOffsetMode::OnManipulatorMoved(const AZ::Vector3& startPosition, const AZ::Vector3& offset, const AZ::EntityComponentIdPair& idPair)
    {
        ...
        JoltPhysics::EditorColliderComponentRequestBus::Event(idPair, &JoltPhysics::EditorColliderComponentRequests::SetColliderOffset, newPosition);
    }

    void ColliderOffsetMode::ResetValues(const AZ::EntityComponentIdPair& idPair)
    {
        JoltPhysics::EditorColliderComponentRequestBus::Event(idPair, &JoltPhysics::EditorColliderComponentRequests::SetColliderOffset, AZ::Vector3::CreateZero());
    }
}
