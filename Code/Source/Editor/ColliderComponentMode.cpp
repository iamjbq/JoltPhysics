...
namespace JoltPhysics
{
    namespace
    {
        ...
        const AZ::Crc32 SetDimensionsSubModeActionUri = AZ_CRC_CE("org.o3de.action.jolt.setdimensionssubmode");
        const AZ::Crc32 SetOffsetSubModeActionUri = AZ_CRC_CE("org.o3de.action.jolt.setoffsetsubmode");
        const AZ::Crc32 SetRotationSubModeActionUri = AZ_CRC_CE("org.o3de.action.jolt.setrotationsubmode");
        const AZ::Crc32 ResetSubModeActionUri = AZ_CRC_CE("org.o3de.action.jolt.resetsubmode");
    } // namespace
    ...
    void ColliderComponentMode::CreateSubModeSelectionCluster()
    {
        ...
        const auto onButtonClicked = [this](AzToolsFramework::ViewportUi::ButtonId buttonId)
        {
            ...
            {
                AZ_Error("Jolt Collider Component Mode", false, "Unrecognized button ID.");
            }
        };
