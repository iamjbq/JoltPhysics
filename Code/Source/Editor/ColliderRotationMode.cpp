...
namespace JoltPhysics
{
    ...
    void ColliderRotationMode::Setup(const AZ::EntityComponentIdPair& idPair)
    {
            ...
            (const AzToolsFramework::AngularManipulator::Action& action)
        {
            ...
            JoltPhysics::EditorColliderComponentRequestBus::Event(idPair, &JoltPhysics::EditorColliderComponentRequests::SetColliderRotation, action.LocalOrientation());
        });
    ...
    {
        JoltPhysics::EditorColliderComponentRequestBus::Event(idPair, &JoltPhysics::EditorColliderComponentRequests::SetColliderRotation, AZ::Quaternion::CreateIdentity());
    }
