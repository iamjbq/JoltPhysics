...
namespace JoltPhysics
{
    namespace Pipeline
    {
        ...
        public:
            ...
            AZ_TYPE_INFO(AssetColliderConfiguration, "{A1B46A89-2F0A-47FD-8803-D38D7A88FB23}");
        ...
        public:
            ...
            AZ_TYPE_INFO(MeshAssetData, "{75EA9E8F-4F63-4CDD-9C4D-677C2E1B0C50}");
            ...
            // Wrapping the numeric_limits<AZ::u16>::max function in parentheses to get around the issue with windows.h defining max as a macro.
        ...
        //! Represents a Jolt mesh asset. This is an AZ::Data::AssetData wrapper around MeshAssetData
        class MeshAsset
            : public AZ::Data::AssetData
        {
        public:
            AZ_CLASS_ALLOCATOR(MeshAsset, AZ::SystemAllocator);
            AZ_RTTI(MeshAsset, "{DF1FA85A-83B2-4A27-BA44-C0C3B8B571F6}", AZ::Data::AssetData);
