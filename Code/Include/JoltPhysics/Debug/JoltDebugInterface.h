...
namespace JoltPhysics
{
    namespace Debug
    {
        //! Event to notify changes to the Collider proximity visualization data.
        ...
        // //! Event to notify changes to the Jolt Visual Debugger (PVD) Configuration.
        ...
        //! Interface for interacting with the Jolt Debug options.
        class JoltDebugInterface
        {
        public:
            AZ_TYPE_INFO(JoltDebugInterface, "{65828BA9-0934-4DDA-B969-CA3EFC88F4BA}");

            JoltDebugInterface() = default;
            virtual ~JoltDebugInterface() = default;
            AZ_DISABLE_COPY_MOVE(JoltDebugInterface);
            ...
            // //! Get the Configuration options to use when connecting / interacting with the Jolt Visual Debugger (PVD)
            // virtual const PvdConfiguration& GetJoltPvdConfiguration() const = 0;

            //! Get the debug display configuration of Jolt
